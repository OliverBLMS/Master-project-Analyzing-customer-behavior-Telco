...
The test CDR dataset only contain 100 record, whereas each record represents an edge between two nodes. 
Instead of working on this test dataset, I created a dummy set on my own. The test set only contains isolated relationships between two nodes.
